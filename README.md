...
```ruby
json_string = MovieSerializer.new(movie).serialized_hash.to_json
```
...
MovieSerializer.new(movies, options).serialized_hash
```
...
json_string = MovieSerializer.new(movies, options).serialized_hash
```
